...
Use the publish checklist against commit `8d24765`, then make the public
artifact-scope call: macOS-only alpha, or macOS plus clearly experimental
Windows/Linux attachments.
